            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                for (int i = 0; i < facturesFinal.size(); i++) {
                    if (facturesFinal.get(i).equals(itemLlista)) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(LlistatFacturesClient.this);
                        builder.setTitle("Eliminar Factura");
                        builder.setMessage("Realment vols eliminar la faxtura?");
                        builder.setPositiveButton("Eliminar", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                EliminarReservaApi eliminarReservaApi = new EliminarReservaApi(LlistatFacturesClient.this, url +"esborrarreserva/", codiAcces, idReserva);
