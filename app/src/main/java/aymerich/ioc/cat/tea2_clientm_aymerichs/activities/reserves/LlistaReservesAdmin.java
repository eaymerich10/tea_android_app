...
public class LlistaReservesAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_llista_reserves_admin);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(LlistaReservesAdmin.this, android.R.layout.simple_list_item_1, reservesFinal);
                    ...
                    if (reservesFinal.get(i).equals(itemLlista)) {
                        ...
                        builder.setPositiveButton("Eliminar", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                EliminarReservaApi eliminarReservaApi = new EliminarReservaApi(LlistaReservesAdmin.this, url +"esborrarreserva/", codiAcces, idReserva);
