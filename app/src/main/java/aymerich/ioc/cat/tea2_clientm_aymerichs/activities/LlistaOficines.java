...
import aymerich.ioc.cat.tea2_clientm_aymerichs.network.EliminarOficinaApi;
import aymerich.ioc.cat.tea2_clientm_aymerichs.network.HabilitarOficinaApi;
import aymerich.ioc.cat.tea2_clientm_aymerichs.network.LlistatOficinesApi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        llistaSales.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                ((TextView) fragment.getView().findViewById(R.id.tipus_oficina_frag_value)).setText(oficina.getTipus());
